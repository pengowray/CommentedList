...
public class TaggedItemReader {
    ...
    public static readonly TaggedItemReader Reader = new();
    public static readonly TaggedItemReader ReaderWithXTags = new(xTags: true);
    ...
    public IEnumerable<TaggedItem> Read(TextReader reader) {
        ...
        while ((line = reader.ReadLine()) != null) {
            ...
            if (XTags && (comment?.Contains("x", StringComparison.InvariantCultureIgnoreCase) ?? false)) {
